...
import {Home,Post_ico,New_ico,Search_ico,Funnel,Notif,Share,Votee,Repost,Vieww,Comments,Whatsapp,Facebook,Eclipse,Sharee,Link,Pen,Eye
} from "../../../assets/icons";
      ...
      <View style={styles.topHeader}>
        ...
        <View style={styles.headerIcons}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Notification")}>
            <Notif width={22} height={18} style={{ marginLeft: 10 }} />
          </TouchableOpacity>
        </View>
      </View>
